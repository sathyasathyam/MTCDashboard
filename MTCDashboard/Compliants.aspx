<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Compliants.aspx.cs" Inherits="MTCDashboard.Compliants" %>
            ...
            <div class="sidebar">
                <div class="sidebar-wrapper">
                    ...
                    <ul class="nav">
                        ...
                        <li>
                            <a class="nav-link active" href="Compliants.aspx">
                            ...
                            <div class="col-md-12">
                                <div class="card  card-tasks">
                                    <div class="card-header ">
                                        <h4 class="card-title">Compliant Dashboard</h4>
                                    </div>
                                    <div class="card-body ">
